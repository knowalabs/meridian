---
name: review-diff
description: Use to review the current diff against Meridian's module boundaries and code-style conventions before it is committed.
---
...
- @.meridian/rules.md — the canonical mirror of the same rules
