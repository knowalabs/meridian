...
> Generated by \`knowa generate\`. Give this file to AI coding assistants for instant project context.
...
project evolves — AI assistants read it via .knowa/.
`;
}
