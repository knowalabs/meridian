...
const HEADER = `<!-- Generated by meridian generate — edit .meridian/rules.md and re-run to update. -->`;
...
export const RULE_TARGETS: RuleTarget[] = [
  ...
  },
  {
    id: 'cursor',
    name: 'Cursor',
    file: path.join('.cursor', 'rules', 'meridian.mdc'),
    render: (rules, project) => `---
description: ${project} project rules (generated by Meridian)
alwaysApply: true
---
...
- Read .meridian/rules.md, docs/architecture.md and docs/conventions.md, plus
 ...
 * `.meridian/rules.md`.
 *
 * The kit tells users to edit `.meridian/rules.md` and re-run, but nothing
 * detected the window in between: a hand-edited rules file whose mirrors still
 * carry the previous text. `meridian sync` uses this to close it.
 *
