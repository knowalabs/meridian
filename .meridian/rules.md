...
- This is `@sonalsithara/meridian`, a Node/TypeScript CLI (`meridian`) that makes _other_ codebases AI-assistant-ready. Keep "the target project" (what `meridian generate` scans) strictly separate from "this repo" (Meridian's own source) — never conflate the two.
